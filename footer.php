        ...
        <div class="footer-flex">
            ...
            <div class="footer-section social-footer">
                ...
                <ul>
                    ...
                    <li><a href="<?= array_key_exists(1, $socialNav) ? $socialNav[2]->url  : 'https://www.instgram.com'?>">
                            <div class="icon-wrapper"><svg aria-hidden="true" focusable="false"
                            ...
                            <span><?= array_key_exists(1, $socialNav) ? $socialNav[2]->post_title : 'Instagram Page' ?></span>
                            <svg aria-hidden="true" focusable="false" data-prefix="fab"
