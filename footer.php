                    ...
                    <div class="social-footer">
                        ...
                        <ul>
                            <li><a href="<?= array_key_exists(1, $socialNav) ? $socialNav[0]->url  : 'www.facebook.com'?>">
                                    ...
                                    <span><?= array_key_exists(1, $socialNav) ? $socialNav[0]->post_title : 'Sumisip Facebook' ?></span>
                                </a></li>
                            <li><a href="<?= array_key_exists(1, $socialNav) ? $socialNav[1]->url : 'www.twitter.com'?>">
                                    ...
                                    <span><?= array_key_exists(1, $socialNav) ? $socialNav[1]->post_title : 'Sumisip Twitter' ?></span>
                                </a></li>
                            <li><a href="<?= array_key_exists(2, $socialNav) ?  $socialNav[2]->url : 'www.instagram.com' ?>">
                                    ...
                                    <span><?= array_key_exists(2, $socialNav) ? $socialNav[2]->post_title : 'Sumisip Instagram'  ?></span>
