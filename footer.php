                    ...
                    <div class="sumisip-about-footer">
                        <div class="visit-content">
                            ...
                            <?php  if(get_theme_mod('ju_footer_sumisip_description')) {
                                ?>
                                    <p><?= get_theme_mod('ju_footer_sumisip_description')?></p>
                    ...
                    <div class="social-footer">
                        ...
                        <ul>
                            <li><a href="<?= array_key_exists(1, $socialNav) ? $socialNav[0]->url  : 'www.facebook.com'?>">
                                    ...
                                    <span><?= array_key_exists(1, $socialNav) ? $socialNav[0]->post_title : 'Facebook - Not Available' ?></span>
                                </a></li>
                            <li><a href="<?= array_key_exists(1, $socialNav) ? $socialNav[1]->url : 'www.twitter.com'?>">
                                    ...
                                    <span><?= array_key_exists(1, $socialNav) ? $socialNav[1]->post_title : ' Twitter - Not Available' ?></span>
                                </a></li>
                            <li><a href="<?= array_key_exists(2, $socialNav) ?  $socialNav[2]->url : 'www.instagram.com' ?>">
                                    ...
                                    <span><?= array_key_exists(2, $socialNav) ? $socialNav[2]->post_title : ' Instagram - Not Available'  ?></span>
