...
VP_Security::instance()->whitelist_function('vp_dep_is_upload');

function vp_dep_is_upload($value)
{
	if($value === 'upload')
		return true;
	return false;
...
VP_Security::instance()->whitelist_function('vp_dep_is_youtube_url');

function vp_dep_is_youtube_url($value)
{
