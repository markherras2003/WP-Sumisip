 ...
 * @since 1.0.0
 */
class SumisipHubCompositionContent extends Widget_Base {
    ...
    public function get_name() {
        return 'sumisip-hub-composition-content';
    }
    /**
    ...
    public function get_title() {
        return __( 'Sumisip Hub Composition Content', 'sumisip-element' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => __( 'Hub Composition Content', 'sumisip-element' ),
            ]
        );
