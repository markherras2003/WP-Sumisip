 ...
 * @since 1.0.0
 */
class SumisipPostComposition extends Widget_Base {
    ...
    public function get_name() {
        return 'sumisip-post-composition';
    }
    /**
    ...
    public function get_title() {
        return __( 'Sumisip Post Composition', 'sumisip-element' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => __( 'Page Items', 'sumisip-element' ),
            ]
        );
